...
namespace Linework.SurfaceFill
{
    ...
    public class SurfaceFill : ScriptableRendererFeature
    {
        private class SurfaceFillPass : ScriptableRenderPass
        {
            ...
            public bool Setup(ref SurfaceFillSettings surfaceFillSettings, ref Material maskMaterial, ref Material fillMaterial, ref Material clearMaterial)
            {
                ...
                foreach (var fill in settings.Fills)
                {
                    ...
                    fill.material.SetFloat(ShaderPropertyId.Rotation, fill.rotation);
        ...
        private Material maskMaterial, fillMaterial, clearMaterial;
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            var render = surfaceFillPass.Setup(ref settings, ref maskMaterial, ref fillMaterial, ref clearMaterial);
        ...
        private bool CreateMaterials()
        {
            ...
            return maskMaterial != null && fillMaterial != null && clearMaterial != null;
        }
    }
}
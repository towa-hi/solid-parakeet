Shader "Hidden/Outlines/Edge Detection/Section"
{
    ...
    SubShader
    {
        ...
        Pass // 0: OBJECT ID
        {
            ...
            #pragma multi_compile _ OBJECT_ID
            #pragma multi_compile _ INPUT_VERTEX_COLOR INPUT_TEXTURE
            #pragma multi_compile VERTEX_COLOR_CHANNEL_R VERTEX_COLOR_CHANNEL_G VERTEX_COLOR_CHANNEL_B VERTEX_COLOR_CHANNEL_A
            #pragma multi_compile TEXTURE_CHANNEL_R TEXTURE_CHANNEL_G TEXTURE_CHANNEL_B TEXTURE_CHANNEL_A
            #pragma multi_compile TEXTURE_UV_SET_UV0 TEXTURE_UV_SET_UV1 TEXTURE_UV_SET_UV2 TEXTURE_UV_SET_UV3
            ...
            Varyings vert(Attributes IN)
            {
                ...
                #endif
                #if defined(INPUT_TEXTURE)
                OUT.uv = TRANSFORM_TEX(IN.uv, _SectionTexture);
                #endif
                return OUT;
            }
            ...
            half4 frag(Varyings IN) : SV_TARGET
            {
                ...
                #if defined(INPUT_VERTEX_COLOR) // Vertex color.
                ...
                #if defined(INPUT_TEXTURE) // Section texture.

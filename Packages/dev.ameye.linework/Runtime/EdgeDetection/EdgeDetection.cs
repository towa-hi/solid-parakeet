    ...
    public class EdgeDetection : ScriptableRendererFeature
    {
        private class EdgeDetectionPass : ScriptableRenderPass
        {
            ...
            public bool Setup(ref EdgeDetectionSettings edgeDetectionSettings, ref Material sectionMaterial, ref Material outlineMaterial)
            {
                ...
                {
                    case DebugView.None:
                        outline.DisableKeyword(ShaderFeature.DebugSectionMapPerceptual);
                        outline.DisableKeyword(ShaderFeature.DebugSectionMapRaw);
                        outline.DisableKeyword(ShaderFeature.DebugLines);
                        ...
                        break;
                    case DebugView.SectionMapPerceptual:
                        outline.EnableKeyword(ShaderFeature.DebugSectionMapPerceptual);
                        outline.DisableKeyword(ShaderFeature.DebugSectionMapRaw);
                        outline.DisableKeyword(ShaderFeature.DebugLines);
                        outline.DisableKeyword(ShaderFeature.DebugDepth);
                        outline.DisableKeyword(ShaderFeature.DebugNormals);
                        outline.DisableKeyword(ShaderFeature.DebugLuminance);
                        break;
                    case DebugView.SectionMapRaw:
                        outline.DisableKeyword(ShaderFeature.DebugSectionMapPerceptual);
                        outline.EnableKeyword(ShaderFeature.DebugSectionMapRaw);
                        outline.DisableKeyword(ShaderFeature.DebugLines);
                        outline.DisableKeyword(ShaderFeature.DebugDepth);
                        outline.DisableKeyword(ShaderFeature.DebugNormals);
                        outline.DisableKeyword(ShaderFeature.DebugLuminance);
                        break;
                    case DebugView.LinesOnly:
                        outline.DisableKeyword(ShaderFeature.DebugSectionMapPerceptual);
                        outline.DisableKeyword(ShaderFeature.DebugSectionMapRaw);
                        outline.EnableKeyword(ShaderFeature.DebugLines);
                        outline.DisableKeyword(ShaderFeature.DebugDepth);
                        outline.DisableKeyword(ShaderFeature.DebugNormals);
                        outline.DisableKeyword(ShaderFeature.DebugLuminance);
                        break;
                ...
                if (edgeDetectionSettings.discontinuityInput.HasFlag(DiscontinuityInput.SectionMap)) outline.EnableKeyword(ShaderFeature.SectionDiscontinuity);
                ...
                outline.SetFloat(ShaderPropertyId.OutlineWidth, edgeDetectionSettings.outlineWidth);

                outline.SetColor(ShaderPropertyId.BackgroundColor, edgeDetectionSettings.backgroundColor);
                outline.SetColor(ShaderPropertyId.OutlineColor, edgeDetectionSettings.outlineColor);
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                // 1. Section.
                // -> Render section map.
                if (settings.discontinuityInput.HasFlag(DiscontinuityInput.SectionMap))
                {
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            edgeDetectionPass.ConfigureInput(ScriptableRenderPassInput.Normal | ScriptableRenderPassInput.Color | ScriptableRenderPassInput.Depth);
#if UNITY_6000_0_OR_NEWER

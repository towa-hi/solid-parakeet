...
namespace Linework
{
    public static class ShaderPassName
    {
        public const string Clear = "Clear Stencil";
    ...
    public static class RenderUtils
    {
        ...
        private static readonly ShaderTagId SRPDefaultUnlit = new("SRPDefaultUnlit"); // for shadergraph shaders
        ...
        {
            using var builder = renderGraph.AddRasterRenderPass<PassData>(ShaderPassName.Debug, out _);
        ...
        {
            using var builder = renderGraph.AddRasterRenderPass<PassData>(ShaderPassName.Clear, out _);

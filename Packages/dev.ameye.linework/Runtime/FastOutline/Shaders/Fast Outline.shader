Shader "Hidden/Outlines/Fast Outline/Outline"
{
    ...
    SubShader
    {
        ...
        Pass // 7: BAKED DIRECTION (OBJECT SPACE)
        {
            Name "BAKED DIRECTION (OBJECT SPACE)"
            ...
            Varyings vert(Attributes IN)
            {
	            ...
	            float3 bitangentOS = normalize(cross(IN.normalOS, tangentOS) * IN.tangentOS.w);
	            float3x3 tbn = float3x3(tangentOS, bitangentOS, IN.normalOS);

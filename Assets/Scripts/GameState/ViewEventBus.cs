...
public static class ViewEventBus
{
    ...
    public static event Action<Dictionary<Vector2Int, Rank?>> OnSetupCommitMarkersChanged;
    ...
    public static void RaiseSetupCommitMarkersChanged(Dictionary<Vector2Int, Rank?> byTile) => OnSetupCommitMarkersChanged?.Invoke(byTile);
